...
const PAGE_HEAD = [
  ...
  "",
  '  .brain-panel { flex-direction: column; width: 100%; background: #0B0B0D; color: #FFFFFF; height: calc(100vh - 124px); overflow-y: auto; }',
  ...
  "  .brain-toolbar .view-toggle { display: flex; background: #141417; border-radius: 12px; padding: 3px; }",
  "  .brain-toolbar .view-toggle button { background: transparent; border: none; color: #A1A1A6; padding: 7px 14px; border-radius: 10px; font-size: 13px; cursor: pointer; }",
  "  .brain-toolbar .view-toggle button.active { background: #2A2A2F; color: #FFFFFF; }",
  "  .brain-capture { background: rgba(20,20,23,0.7); backdrop-filter: blur(25px); border: 1px solid #2A2A2F; border-radius: 18px; padding: 14px; margin-bottom: 18px; box-shadow: 0 8px 24px rgba(0,0,0,0.35); }",
  "  .brain-capture textarea { width: 100%; padding: 10px; border-radius: 12px; border: 1px solid #2A2A2F; background: #0B0B0D; color: #FFFFFF; font-family: inherit; font-size: 14px; resize: vertical; }",
  "  .brain-capture button.add { margin-top: 8px; padding: 9px 18px; background: #4DA3FF; color: #0B0B0D; font-weight: 600; border: none; border-radius: 10px; cursor: pointer; }",
  "  .know-list { display: grid; grid-template-columns: repeat(auto-fill, minmax(240px, 1fr)); gap: 12px; }",
  "  .know-item { background: rgba(20,20,23,0.7); backdrop-filter: blur(25px); border: 1px solid #2A2A2F; border-radius: 18px; padding: 14px; display: flex; flex-direction: column; gap: 8px; box-shadow: 0 8px 24px rgba(0,0,0,0.25); }",
  "  .know-item .know-content { font-size: 13px; line-height: 1.4; color: #FFFFFF; }",
  "  .know-item .know-meta { font-size: 11px; color: #A1A1A6; display: flex; justify-content: space-between; }",
  "  .know-item .know-meta .source-tag { background: #2A2A2F; padding: 2px 8px; border-radius: 8px; }",
  "  .know-item .know-meta .source-tag.auto { background: rgba(100,210,255,0.18); color: #64D2FF; }",
  "  .know-item button.del { align-self: flex-end; background: rgba(239,68,68,0.15); color: #EF4444; border: none; border-radius: 8px; padding: 5px 10px; cursor: pointer; font-size: 12px; }",
  "  .graph-wrap { background: #0F1117; border: 1px solid #2A2A2F; border-radius: 18px; overflow: hidden; position: relative; height: 60vh; }",
  "  #graphCanvas { width: 100%; height: 100%; display: block; cursor: grab; }",
  "  .graph-detail { display: none; margin-top: 14px; background: rgba(20,20,23,0.85); backdrop-filter: blur(25px); border: 1px solid #2A2A2F; border-radius: 18px; padding: 14px; }",
  "  .graph-detail.open { display: block; }",
  "  .graph-detail .know-meta { font-size: 11px; color: #A1A1A6; margin-bottom: 8px; }",
  "",
...
"var allKnowledge = [];",
  ...
  "      var shared = graphNodes[i].words.some(function (w2) { return graphNodes[j].words.indexOf(w2) !== -1; });",
  "      if (shared) {",
  "        ctx.beginPath();",
  ...
  "    ctx.fillStyle = n.source === \"auto\" ? \"#64D2FF\" : \"#4DA3FF\";",
  "    ctx.fill();",
  ...
  "    var hit = graphNodes.find(function (n) { return Math.hypot(n.x - mx, n.y - my) <= n.r + 4; });",
  '    var detail = document.getElementById("graphDetail");',
  "    if (!hit) { detail.classList.remove(\"open\"); return; }",
