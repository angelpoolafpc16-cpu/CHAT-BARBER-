...
const PAGE_HEAD = [
  ...
  "  .notes-sidebar .ns-actions button.secondary.active-split { background: #0A84FF; color: #fff; }",
  ...
  '            <button class="secondary" id="splitToggleBtn" onclick="toggleSplitView()">⬛ Split</button>',
...
"var allKnowledge = [];",
  ...
  '    var div = document.createElement("div");',
  '    div.className = "ns-item" + (n.id === activeTabId || n.id === secondTabId ? " active" : "");',
  ...
  "    if (splitView && activeTabId && n.id !== activeTabId) {",
  '      div.title = "Clic para abrir en el panel derecho";',
  "      div.onclick = function () { openNoteTab(n.id, true); };",
  "    } else {",
  ...
  '  document.getElementById("splitToggleBtn").classList.toggle("active-split", splitView);',
  "  renderNotesList();",
  "  renderPanes();",
  "}",
  "",
  ...
  "  if (splitView) {",
  "    var note2 = secondTabId ? findNote(secondTabId) : null;",
  "    if (note2) {",
  "      panesEl.appendChild(buildPaneEl(note2, !!note2._preview));",
  "    } else {",
  '      var placeholder = document.createElement("div");',
  '      placeholder.className = "note-pane ns-empty";',
  '      placeholder.textContent = "Haz clic en otra nota de la lista para abrirla aquí";',
  "      panesEl.appendChild(placeholder);",
  "    }",
  "  }",
  "}",
  "",
